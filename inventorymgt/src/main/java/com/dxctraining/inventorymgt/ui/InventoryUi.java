...
public class InventoryUi {
	...
	private void runapp() {
		try {
			...
			Supplier supplier2=new Supplier("sailaja");
			service.add(supplier2);
			Supplier supplier3=new Supplier("priya");
		    ...
		    Computer computer=new Computer("dell",supplier2,1000);
		    computerservice.add(computer);
			Phone phone=new Phone("mi",supplier1,20);
